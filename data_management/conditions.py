...
The first element of the tuple is the independent term.
The second element of the tuple is the dependent term.

The function get_wordcount_counter (of analyses.py) will not consider tuples 
unless the second term is **totally** dependent on the first; meaning, the presence 
of the second term is near impossible without equal presence of the first term.
'''
...
Key is the conventionally popular (dominant) term, and values are equivalent but lesser alternatives.

If unsure of hierarchy, compare corpus.get_wordcount_counter()[word].

The function get_word_windows (of analyses.py) will not consider nuances in meaning. 
Ensure that key and values are terms **totally** equivalent in meaning.

Most are American/British equivalents and were implemented from:
...
identities = {
    ...
    'neoclassicism': ['neo-classicism', 'neoclassic', 'neo-classic', 'neoclassical', 'neo-classical'],
    'neoclassic': ['neo-classic', 'neoclassicism', 'neo-classicism'],
    'neoclassical': ['neo-classical', 'neoclassicism', 'neo-classicism'],
